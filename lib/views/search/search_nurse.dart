...
class SearchNurse extends StatefulWidget {
  const SearchNurse({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _SearchNurseState createState() => _SearchNurseState();
}

class _SearchNurseState extends State<SearchNurse> {
